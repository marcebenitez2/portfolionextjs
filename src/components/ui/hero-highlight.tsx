...
export const HeroHighlight = ({
  ...
  return (
    ...
    >
      ...
      {/* Efecto de máscara con movimiento del ratón */}
      <motion.div
      ...
      {/* Degradado superior */}
      <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-white dark:from-black to-transparent z-10 pointer-events-none" />
